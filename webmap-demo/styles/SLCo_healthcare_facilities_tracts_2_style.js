...
var style_SLCo_healthcare_facilities_tracts_2 = function(feature, resolution){
    ...
    var labelText = ""; var value = feature.get("objectid");
    ...
    if (value >= 19.000000 && value <= 71.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 71.000000 && value <= 126.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 126.000000 && value <= 195.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 195.000000 && value <= 250.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 250.000000 && value <= 588.000000) {
            style = [ new ol.style.Style({
